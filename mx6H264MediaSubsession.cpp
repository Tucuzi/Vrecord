...
mx6H264MediaSubsession* mx6H264MediaSubsession::createNew (UsageEnvironment &env, FramedSource *source)  
{  
    return new mx6H264MediaSubsession(env, source);  
}  
      
mx6H264MediaSubsession::mx6H264MediaSubsession (UsageEnvironment &env, FramedSource *source)  
...
{  
    ...
    {  
        fprintf(stderr, "[%d] %s .... calling\n", getpid(), __func__);  
        bitrate = 500;  
        return H264VideoStreamFramer::createNew(envir(), new mx6H264Source(envir()));  
    }  
